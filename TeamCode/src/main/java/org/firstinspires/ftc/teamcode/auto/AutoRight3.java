...
//
//        // let go of preload
//        hardware.claw.goTo(OutClaw.OPEN).run();
//
//        // step back
//        poser.moveBy(
//                Distance.inInches(5),
...
//                hardware.swivel.goTo(InSwivel.MIDDLE),
//                hardware.wrist.goTo(InWrist.State.DOWN),
//                hardware.claw.goTo(OutClaw.OPEN)
//        ).run();
//
//        // grab the sample
//        hardware.intake.goTo(InClaw.CLOSED).run();
//
//        ConcurrentSet.of(
//                // drop the sample into the bucket
//                Sequence.of(
//                        ConcurrentSet.of(
//                                hardware.swivel.goTo(InSwivel.BUCKET),
//                                hardware.wrist.goTo(InWrist.State.BUCKET)
//                        ),
//                        hardware.intake.goTo(InClaw.OPEN),
//                        hardware.wrist.goTo(InWrist.State.UP)
//                ),
...
//        sleep(5000);
//
//        hardware.wrist.setPosition(InWrist.State.BUCKET);
//
//        dter.poll();
//        lift.setTarget(200);
//
...
//        ).run();
//
//        hardware.claw.goTo(OutClaw.CLOSED).run();
//
//        dter.poll();
//        lift.setTarget(2200);
