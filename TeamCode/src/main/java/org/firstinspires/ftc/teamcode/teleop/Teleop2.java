...
import org.firstinspires.ftc.teamcode.subsystems.TeleRobotANewHope;
...
public class Teleop2 extends OpModeWrapper {
    ...
    public void setup() {
        ...
        robot = new TeleRobotANewHope(hardware);
...
//        if (gamepads.justPressed(Controls.HALF_SEQUENCE_MODE)) robot.pressHalfSequenceModeButton();
        ...
        drive.update(dt);
        robot.update(dt, fieldOrienter.facingPosY());
    }
}
