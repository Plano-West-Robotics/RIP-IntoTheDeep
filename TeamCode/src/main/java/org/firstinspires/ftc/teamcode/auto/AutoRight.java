...
//        ).run();
//
//        hardware.swivel.setPosition(InSwivel.MIDDLE);
//        hardware.wrist.setPosition(InWrist.State.DOWN);
//        hardware.intake.open();
//        sleep(1000);
//        hardware.intake.close();
//        sleep(250);
//        hardware.swivel.setPosition(InSwivel.BUCKET);
//        hardware.wrist.setPosition(InWrist.State.BUCKET);
//        sleep(1000);
//        hardware.intake.open();
//        sleep(500);
//        hardware.wrist.setPosition(InWrist.State.UP);
//
//        poser.moveBy(
