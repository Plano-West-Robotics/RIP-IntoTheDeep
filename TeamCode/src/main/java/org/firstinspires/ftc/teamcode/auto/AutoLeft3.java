...
//
//@Autonomous(name = "Left Auto (4 + N sample)", preselectTeleOp = "DDDDDDDDD")
//public class AutoLeft3 extends AutoBase {
//    @Override
...
//
//        ArrayList<Pose> samples = SampleTracker.waitForStartWithTracker(this);
//
//        ////////////////////
//        //  first sample  //
//        ////////////////////
...
//            Distance robotY = sample.pos.y;
//            Distance robotX = Distance.inTiles(-1.1);
//            Angle robotAngle = Angle.FORWARD;
//            Distance clawExt = sample.pos.x.sub(robotX);
//            Angle swivelAngle = sample.yaw.add(robotAngle);
//
//            ConcurrentSet.of(
//                    Sequence.of(
//                            ConcurrentSet.of(
...
//                            ),
//                            ConcurrentSet.of(
//                                    hardware.extend.toClawX(clawExt),
//                                    poser.goToX(robotX)
//                            ),
//                            hardware.inWrist.goTo(InWrist.State.DOWN),
//                            hardware.inSwivel.goTo(swivelAngle),
//                            hardware.inClaw.toClosed(),
//                            ConcurrentSet.of(
//                                    hardware.inSwivel.goTo(InSwivel.MIDDLE),
//                                    hardware.inWrist.goTo(InWrist.State.UP)
//                            )
